            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">koustavkhanda7@gmail.com</span>
                        
                        <a href="mailto:koustavkhanda7@gmail.com" className="contact__button">
                            Write Me{" "} 
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">@bong_drifter</span>
                        
                        <a href="https://www.instagram.com/bong_drifter/" target="_blank" rel="noreferrer" className="contact__button">
                            Follow Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
